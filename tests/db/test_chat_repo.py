...
def fake_messages():
    messages = [
        Message(role="system", content="I am a system message"),
        Message(role="user", content="some user message"),
        Message(role="assistant", content="some reply from openhermes"),
        Message(role="user", content="some other user message"),
    ]
    return messages
