...
def fake_scores():
    fs = [
        ScoreEntry(
            ...
            filename="test.docx",
            model_name="skynet",
            scores={"true_positives": 2, "irrelevant": 0, "concise": 1},
        ),
        ScoreEntry(
            run=0,
            filename="test.docx",
            model_name="HAL-9000",
            scores={"false_negatives": 2, "irrelevant": 1, "concise": 0},
        ),
        ScoreEntry(
            run=0,
            filename="test.docx",
            model_name="nautilus:5b",
            scores={"false_negatives": 0, "irrelevant": 1, "concise": 0},
        ),
        ScoreEntry(
            run=0,
            filename="second_test.docx",
            model_name="skynet",
            scores={"true_positives": 1, "irrelevant": 2, "concise": 3},
        ),
    ]
    return fs
...
def fake_run():
    return EvalDoc(
        ...
        filename="test.docx",
        system_message="test",
        models={"skynet": "I generated something", "legion": "I did not"},
        exec_times={},
    )
